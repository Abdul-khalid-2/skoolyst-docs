...
<head>
  ...
  <meta name="twitter:description" content="How to use the Stores module within the Skoolyst application." />
...
?>
  ...
  <main id="main-content">
    <article class="doc-article">
      ...
      <p>The Stores module is currently in development. The following capabilities are planned:</p>
      <ul>
        <li>Browse listed educational products and materials</li>
        <li>Search and filter products by category</li>
        <li>View product details and listings</li>
      </ul>
      ...
      <div class="info-banner">
        ...
        <div class="info-content">
          <p>Stores is planned to become a separate application under <code>stores.skoolyst.com</code>. Currently, it operates as a module within the main Skoolyst application. The separate subdomain represents the planned future architecture.</p>
        </div>
      </div>
