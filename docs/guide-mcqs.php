...
<head>
  ...
  <meta name="twitter:description" content="How to use the MCQs module within the Skoolyst application." />
...
?>
  ...
  <main id="main-content">
    <article class="doc-article">
      ...
      <h1>MCQs Module</h1>
      <p class="lead">The MCQs module provides multiple-choice question practice and assessment tools within the Skoolyst platform.</p>

      <h2 id="overview">Overview</h2>
      <p>The MCQs module is one of the four core modules within the main Skoolyst application. It is designed to provide a library of multiple-choice questions for practice and assessment, helping students prepare for exams and teachers evaluate understanding.</p>
      <p><span class="status-badge status-development">In Development</span></p>

      <h2 id="current-capabilities">Current Capabilities</h2>
      <p>The MCQs module is currently in development. The following capabilities are planned:</p>
      <ul>
        <li>Browse a question bank organized by subject</li>
        <li>Practice questions with instant feedback</li>
        <li>Take timed assessments with scoring</li>
      </ul>
      ...
      <div class="info-banner">
        ...
        <div class="info-content">
          <p>MCQs is planned to become a separate application under <code>mcqs.skoolyst.com</code>. Currently, it operates as a module within the main Skoolyst application. The separate subdomain represents the planned future architecture.</p>
        </div>
      </div>
